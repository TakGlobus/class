...
int main(int argc, char *argv[])
{
   ...
   AddColumn<ProblemN3>(prAdapter, "g", &ProblemN3::g);
   ...
   if (!isDebugMode)
   {
      for (int i = 0; i < header.problem_count; i++)
      {
         ...
         theProblem.student_answer = FindOptimalColoringWeight(theProblem.r, theProblem.g, theProblem.b);
      }
